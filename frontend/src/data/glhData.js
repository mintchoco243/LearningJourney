...
/* ---------- Ranks (5-tier ladder) ----------
  ...
  export const CHAR_OPTIONS = {
    hair: [
      ...
      { id: "bald", name: "Đầu trọc" },
    ],
    hairColor: [
      { id: "espresso", name: "Nâu đen", color: "#2B2330" },
      { id: "black", name: "Đen", color: "#151318" },
      { id: "auburn", name: "Nâu đỏ", color: "#7A3528" },
      { id: "blonde", name: "Vàng", color: "#D9A441" },
      { id: "blue", name: "Xanh", color: "#285A86" },
      { id: "pink", name: "Hồng", color: "#E85D9E" },
      { id: "white", name: "Trắng", color: "#F1F1F4" },
    ],
    outfit: [
      ...
      { id: "emerald", name: "Lục", color: "#10B981" },
      { id: "orange", name: "Cam", color: "#F97316" },
      { id: "purple", name: "Tím", color: "#8B5CF6" },
      { id: "black", name: "Đen", color: "#2D3748" },
    ],
    accessory: [
      { id: "none", name: "Không" },
      ...
      { id: "backpack", name: "Balo" },
      { id: "cap", name: "Đội mũ" },
      { id: "controller", name: "Tay cầm gaming" },
