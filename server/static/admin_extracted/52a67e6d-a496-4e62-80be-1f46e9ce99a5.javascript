/* =============================================================
   Shared UI helpers: inline line-icons (Lucide-style, 1.75px),
   starfield background, formatters. window.GLHUI
   ============================================================= */
(function () {
  "use strict";
  ...
  const FORMAT_LABEL = { online: "Online", offline: "Trực tiếp", elearning: "E-learning", webinar: "Webinar", workshop: "Workshop", bootcamp: "Bootcamp", talk: "Talk" };
  ...
  window.GLHUI = { Icon, Starfield, fmtDate, fmtDuration, MONTHS_VI, DOW_VI, FORMAT_LABEL };
})();
