/* =============================================================
   Admin shared components: Sidebar, Badge, Modal, Toggle, etc.
   Exports to window.ADMComponents
   ============================================================= */
(function () {
  "use strict";
    ...
    return (
      <aside className="adm-sidebar">
        <div className="adm-sidebar__logo">
          <img src={(window.__resources && window.__resources.adminLogo) || "assets/logo_horizontal.png"} alt="Garena" height={20} />
  ...
  window.ADMComponents = { Badge, Sidebar, PageHeader, StatCard, SectionCard, Modal, Toggle, SearchInput };
})();
