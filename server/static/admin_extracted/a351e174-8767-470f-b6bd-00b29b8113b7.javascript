/* =============================================================
   Admin mock data — realistic Vietnamese workplace context.
   In production: fetched from GET /admin/api/* endpoints.
   ============================================================= */
(function () {
  "use strict";
  ...
  const ADMIN_TESTIMONIALS = [
    { id: "T-001", course_id: "LC-003", course_title: "Giao tiếp hiệu quả",   user_name: "Nguyễn Hoàng Minh",  user_role: "PM, Product",      rating: 5, content: "Khóa học thay đổi cách mình chạy meeting hoàn toàn. Giờ mình biết cách set agenda rõ và close action items.",             is_featured: true,  created_at: "2026-05-20" },
    { id: "T-002", course_id: "LC-003", course_title: "Giao tiếp hiệu quả",   user_name: "Trần Bích Ngọc",     user_role: "Designer, Creative",rating: 5, content: "Trainer rất engaging. Phần role-play thực tế nhất mình từng thấy trong training nội bộ của Garena.",                         is_featured: true,  created_at: "2026-05-18" },
    { id: "T-003", course_id: "LC-006", course_title: "Leadership Foundation", user_name: "Lê Quang Huy",       user_role: "Senior Manager, Ops",rating:5, content: "Bootcamp 2 ngày intenseness nhưng rất xứng đáng. Framework coaching 1-on-1 tôi dùng được ngay từ tuần sau.",                is_featured: true,  created_at: "2026-05-10" },
    { id: "T-004", course_id: "LC-006", course_title: "Leadership Foundation", user_name: "Phạm Thị Lan",       user_role: "Team Lead, HR",    rating: 4, content: "Nội dung tốt, nhưng ước gì có thêm case study từ gaming industry thay vì case chung chung.",                               is_featured: false, created_at: "2026-05-09" },
    { id: "T-005", course_id: "LC-004", course_title: "Tư duy sản phẩm",      user_name: "Vũ Thanh Tùng",      user_role: "Engineer, Backend", rating: 5, content: "Mình là engineer nhưng sau khóa này hiểu rõ hơn tại sao PM quyết định vậy. Cộng tác với team product mượt hơn hẳn.",       is_featured: false, created_at: "2026-04-22" },
    { id: "T-006", course_id: "LC-004", course_title: "Tư duy sản phẩm",      user_name: "Đinh Thị Mai Anh",   user_role: "Analyst, Data",    rating: 4, content: "User journey mapping session rất hay. Muốn có thêm hands-on với Figma thay vì chỉ vẽ giấy.",                               is_featured: true,  created_at: "2026-04-20" },
    { id: "T-007", course_id: "LC-011", course_title: "Quản lý dự án Agile",  user_name: "Hoàng Quốc Bình",    user_role: "Project Manager",  rating: 5, content: "Trainer Đỗ Quốc Bảo có kinh nghiệm thực chiến rất sâu. Sprint planning module đặc biệt hữu ích.",                          is_featured: false, created_at: "2026-06-01" },
    { id: "T-008", course_id: "LC-011", course_title: "Quản lý dự án Agile",  user_name: "Cao Thị Bích",       user_role: "Ops Coordinator",  rating: 3, content: "Nội dung OK nhưng hơi fast-paced. Nên có pre-reading material cho người chưa biết Agile.",                                  is_featured: false, created_at: "2026-06-02" },
  ];
