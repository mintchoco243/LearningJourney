/* =============================================================
   Admin screen — Users & Enrollments
   Exports: window.ADMScreensUsers = { UsersScreen }
   ============================================================= */
(function () {
  "use strict";
  const { Icon } = window.GLHUI;
  const { Badge, PageHeader, StatCard, SectionCard, Modal, SearchInput } = window.ADMComponents;
  ...
  window.ADMScreensUsers = { UsersScreen };
})();
