/* =============================================================
   Screens 1 — Onboarding & Character Creation
   ============================================================= */
(function () {
  "use strict";
  const { Icon, Starfield } = window.GLHUI;
  const { useGame } = window.GLHEngine;
  ...
  function Onboarding(props) {
    ...
    return React.createElement("div", { className: "glh-screen glh-dark glh-center glh-pad fade-screen" },
      ...
      React.createElement("div", { className: "ob-wrap" },
        React.createElement("img", { className: "ob-logo", src: (window.__resources && window.__resources.logo) || "assets/logo_horizontal.png", alt: "Garena" }),
        React.createElement("div", { className: "ob-eyebrow" }, "Learning Hub"),
    ...
    return React.createElement("div", { className: "glh-screen glh-dark glh-center glh-pad fade-screen", style: { position: "relative" } },
      ...
      React.createElement("div", { style: { position: "relative", zIndex: 1, width: "100%", maxWidth: 1040 } },
        React.createElement("div", { style: { textAlign: "center", marginBottom: 28 } },
          ...
          React.createElement("h2", { className: "glh-display", style: { fontSize: "clamp(28px,5vw,44px)", color: "#fff", margin: 0 } }, "Đây là bạn trong Learning Hub")),
  ...
  window.GLHScreens = Object.assign(window.GLHScreens || {}, { Onboarding, CharacterCreation });
})();
