/* =============================================================
   GLHAvatar — parametric "pixel-inspired" geometric avatar.
   Renders a clean chibi character as inline SVG so it scales
   crisply and stays identical across every screen.
   window.GLHAvatar.svg(opts) -> SVG string
   <Avatar opts={...} size={n} crisp={bool} /> -> React node
   ============================================================= */
(function () {
  "use strict";
  ...
  window.GLHAvatar = { svg, Avatar, OUTFIT, SKIN };
})();
