/* =============================================================
   Screens 2 — Placement Quiz & Character Reveal
   ============================================================= */
(function () {
  "use strict";
  const { Icon, Starfield } = window.GLHUI;
  const { useGame, scoreQuiz, rankForXp } = window.GLHEngine;
  ...
  function Quiz(props) {
    ...
    const { Step4LearningStyle, Step5Availability, Step6TrainerPreference } = window.GLHScreens;
  ...
  window.GLHScreens = Object.assign(window.GLHScreens || {}, { Quiz, Reveal });
})();
