/* =============================================================
   Screens — Course Catalog & Training Calendar
   ============================================================= */
(function () {
  "use strict";
  const { Icon, fmtDate, FORMAT_LABEL, MONTHS_VI, DOW_VI } = window.GLHUI;
  ...
  window.GLHScreens = Object.assign(window.GLHScreens || {}, { Catalog, Calendar });
})();
