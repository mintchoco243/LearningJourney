/* =============================================================
   Garena Learning Hub — Fallback data layer
   In production these tabs come from a published Google Sheet (CSV).
   Here we ship static fallback so the prototype is fully playable.
   ============================================================= */
(function () {
  "use strict";
  ...
  /* ---------- Calendar events ---------- */
  const CALENDAR = [
    { event_id:"EV-001", title:"Onboarding Day — Tháng 6", type:"workshop", skill_tags:["foundations"], start_date:"2026-06-09", time:"09:00–12:00", location:"Tầng 12, Garena VN HQ", host:"L&D Team", audience:"Nhân viên mới", url:"#" },
    { event_id:"EV-002", title:"AI Trong Công Việc — Live Session", type:"webinar", skill_tags:["ai"], start_date:"2026-06-16", time:"14:00–15:30", location:"Google Meet", host:"AI Enablement", audience:"Mọi cấp độ", url:"#" },
    { event_id:"EV-003", title:"Workshop Giao Tiếp Hiệu Quả", type:"workshop", skill_tags:["communication"], start_date:"2026-06-23", time:"09:30–12:00", location:"Phòng Saigon, Tầng 10", host:"Lan Nguyễn", audience:"Junior", url:"#" },
    { event_id:"EV-004", title:"Data Storytelling Bootcamp", type:"bootcamp", skill_tags:["analytics","data"], start_date:"2026-07-07", time:"09:00–16:00", location:"Tầng 12, Garena VN HQ", host:"Data Team", audience:"Senior phân tích", url:"#" },
    { event_id:"EV-005", title:"Nền Tảng Lãnh Đạo — Module 1", type:"workshop", skill_tags:["leadership"], start_date:"2026-07-14", time:"13:30–17:00", location:"Phòng Hanoi, Tầng 11", host:"Leadership Academy", audience:"Lead tiềm năng", url:"#" },
    { event_id:"EV-006", title:"Product Thinking Clinic", type:"webinar", skill_tags:["product"], start_date:"2026-07-21", time:"15:00–16:30", location:"Google Meet", host:"Product Guild", audience:"PM, Designer", url:"#" },
    { event_id:"EV-007", title:"Esports Insider Talk", type:"talk", skill_tags:["foundations"], start_date:"2026-08-04", time:"16:00–17:00", location:"Auditorium, Tầng 1", host:"Esports Team", audience:"Mọi cấp độ", url:"#" },
    { event_id:"EV-008", title:"Vận Hành Xuất Sắc — Hội Thảo", type:"workshop", skill_tags:["ops_excellence"], start_date:"2026-08-18", time:"09:00–12:00", location:"Phòng Saigon, Tầng 10", host:"Game Ops", audience:"Ops Lead", url:"#" },
    { event_id:"EV-009", title:"Chiến Lược & Ra Quyết Định", type:"workshop", skill_tags:["strategy"], start_date:"2026-09-08", time:"09:00–16:00", location:"Tầng 12, Garena VN HQ", host:"BD Leadership", audience:"Manager", url:"#" },
    { event_id:"EV-010", title:"Facilitation Skills Lab", type:"workshop", skill_tags:["facilitation"], start_date:"2026-09-22", time:"13:30–17:00", location:"Phòng Hanoi, Tầng 11", host:"L&D Team", audience:"Trainer nội bộ", url:"#" },
  ];
    ...
    try {
      ...
      if (coursesRes.ok) {
        ...
        if (courses && courses.length) {
          window.GLH_DATA.COURSES = courses.map((c) => ({
            course_id: c.id,
            title: c.title,
      ...
      if (sessionsRes.ok) {
        ...
        if (sessions && sessions.length) {
          window.GLH_DATA.CALENDAR = sessions.map((s) => ({
            event_id: s.id,
            title: s.title,
