...
(function () {
  ...
  function Login(props) {
    ...
    return React.createElement("div", { className: "glh-screen glh-dark glh-center glh-pad fade-screen" },
      ...
      React.createElement("div", { className: "ob-wrap", style: { maxWidth: 380 } },
        React.createElement("img", { className: "ob-logo", src: (window.__resources && window.__resources.logo) || "assets/logo_horizontal.png", alt: "Garena", style: { marginBottom: 12 } }),
  ...
  window.GLHScreens = Object.assign(window.GLHScreens || {}, { Login });
})();
